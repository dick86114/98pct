...
### v3.5.0 (2026-01-27)
- ✨ **项目经理代填**：支持 PM 代成员填写发版内容及勾选自查清单，助力进度推进
- ✨ **填报时间追踪**：新增显示成员填报内容的“最后更新时间”
- 💄 **文本格式优化**：修复多行文本展示丢失换行符的问题，保留输入格式
- 💄 **默认浅色主题**：默认主题调整为浅色模式，提供更清爽体验
- 💄 **交互体验升级**：检查清单支持整行点击，优化代编辑按钮交互
- 🔧 **本地化部署**：优化 Docker 配置，默认使用本地构建镜像

### v3.0.0 (2025-01-20)
- 🚀 **性能优化**：全面优化代码性能，减少约 2500 行重复代码
- ✨ **统一图标库**：创建 `Icons.js` 组件库，包含 20+ 个常用图标
- ✨ **工具函数库**：创建 `utils.js` 工具库，包含 15+ 个实用函数
- ⚡ **React 优化**：使用 `memo`、`useMemo`、`useCallback` 优化组件渲染
- 🎨 **UI 重新设计**：
  - 意见反馈详情页采用现代化卡片式设计
  - 用户提交反馈弹窗全新设计
  - 发版记录卡片优化，提升视觉效果
...
- 📦 **体积优化**：项目体积从 770MB 优化到 529MB
- 📚 **文档完善**：
  - 新增性能优化文档 `PERFORMANCE_OPTIMIZATION.md`
  - 新增优化总结文档 `OPTIMIZATION_SUMMARY.md`
  - 新增项目清理文档 `PROJECT_CLEANUP.md`
  - 更新所有相关文档和配置文件
- 🐛 **Bug 修复**：修复组件中未使用的变量警告
- 🔧 **开发体验**：提升代码可维护性和开发效率
...
- ✨ PO 验收意见填报功能
- ✨ 发版总结导出完善，包含所有角色填报数据
- ✨ 附件批量下载功能（按类型分文件夹打包 ZIP）
- ✨ 自定义日期选择器组件
- ✨ 自定义下拉选择组件
- 🐛 修复文件上传在 Docker 环境下的问题
- 🐛 修复上传文件访问 404 的问题
- ⚡ 优化响应式布局，提升移动端体验
